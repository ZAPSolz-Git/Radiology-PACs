            ...
            <main className="ml-14 sm:ml-16 flex-1 flex flex-col overflow-hidden bg-muted/5">
                ...
                <header className="min-h-16 py-3 sm:py-0 bg-background/95 border-b border-border px-4 sm:px-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 flex-shrink-0 sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-background/80">
                    <div className="flex items-center justify-between w-full sm:w-auto">
                        <div>
                            <h1 className="text-lg sm:text-xl font-black tracking-tight text-foreground uppercase">Diagnostic Worklist</h1>
                            <p className="text-[9px] sm:text-[10px] text-muted-foreground font-bold uppercase tracking-wider sm:tracking-[0.2em]">Radiologist Professional Station</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto justify-between sm:justify-end">
                        <div className="flex items-center gap-2">
                            ...
                            <Button
                                ...
                                size="icon"
                                onClick={refresh}
                                className={cn("h-9 w-9 sm:h-10 sm:w-10 rounded-xl border-border/50", isLoading && "animate-spin")}
                            >
                                <RefreshCw className="w-4 h-4 text-foreground/80" />
                            </Button>
                        </div>

                        <div className="h-8 w-px bg-border mx-1 sm:mx-2" />
                                    ...
                                    {reportingCaseId ? (
                                        ...
                                        activeView === 'analytics' ? (
                                            ...
                                            <div className="flex flex-col gap-6 h-full">
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 bg-muted/20 p-1 rounded-2xl w-full sm:w-fit">
                                                    ...
                                                    <Button
                                                        ...
                                                        className={cn(
                                                            "w-full sm:w-auto h-10 px-4 rounded-xl text-[10px] font-black uppercase tracking-wide transition-all justify-between sm:justify-center",
                                                            activeTab === 'active'
                                                    ...
                                                    >
                                                        ...
                                                        <Badge className="ml-2 bg-indigo-100 text-indigo-600 border-none h-5 px-2 text-[9px] shrink-0">
                                                    ...
                                                    >
                                                        ...
                                                        <Badge className="ml-2 bg-emerald-100 text-emerald-600 border-none h-5 px-2 text-[9px] shrink-0">
                                                            {cases.filter(c => c.status === 'Finalized').length}
                                                        </Badge>
                                                    </Button>
