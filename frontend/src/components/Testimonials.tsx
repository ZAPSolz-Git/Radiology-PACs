...
//     id: 1,
//     name: "Dr. Aris Thorne",
//     role: "Chief Radiologist, Neuro Center",
//     message:
...
//     id: 2,
//     name: "Sarah Jenkins",
//     role: "Director of Operations, MedLink Hospital",
//     message:
...
//     id: 3,
//     name: "Michael Lee",
//     role: "Lead Technician, Diagnostic Lab Solutions",
//     message:
...
//   return (
//     <div className="relative w-full min-h-[700px] flex items-center justify-center overflow-hidden bg-slate-950">
...
//       {/* Main Content */}
//       <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 py-20">
//         <div className="text-center mb-16 space-y-4">
//           <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm">Voices of Excellence</h2>
//           <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
//             Valued by the World's <br /> Leading Professionals
//           </h1>
...
//                 className={`relative p-8 rounded-[2.5rem] border transition-all duration-700 h-full flex flex-col
//                   ${index === 1
//                     ? "bg-white/10 border-white/20 backdrop-blur-2xl scale-105 z-20 shadow-2xl shadow-blue-500/10"
//                     : "bg-white/5 border-white/10 backdrop-blur-xl scale-100 z-10 opacity-70"
//                   }
//                 `}
//               >
...
//                   <Quote className="w-12 h-12 text-blue-500 relative z-10" />
//                 </div>

//                 <p className="text-lg md:text-xl text-slate-100 leading-relaxed italic mb-8 flex-grow">
//                   “{testimonial.message}”
//                 </p>
...
//           {/* Navigation Controls */}
//           <div className="absolute top-1/2 -left-4 -right-4 md:-left-8 md:-right-8 flex justify-between items-center -translate-y-1/2 pointer-events-none">
//             <button
//               onClick={prevSlide}
//               className="w-14 h-14 rounded-full border border-white/10 bg-white/5 backdrop-blur-md flex items-center justify-center text-white hover:bg-blue-600 hover:border-blue-500 transition-all pointer-events-auto transform hover:scale-110 active:scale-95 group shadow-xl"
//             >
...
//               className={`h-1.5 rounded-full transition-all duration-300 ${current === i ? "w-8 bg-blue-500" : "w-2 bg-white/20"
//                 }`}
//             />
//           ))}
//         </div>
