...
const StudyBrowser = ({
  ...
  return (
    <ScrollArea>
      <div
        className="bg-[#060a10] flex flex-1 flex-col gap-[6px] px-1 py-1"
        data-cy={'studyBrowser-panel'}
      >
        <div className="flex flex-col gap-[6px]">
          {showSettings && (
            <div className="bg-[#0a0f18] border border-primary/10 shadow-lg flex h-[44px] items-center justify-center gap-[10px] px-[8px] py-[10px] rounded-lg mb-1 mx-1">
              <>
