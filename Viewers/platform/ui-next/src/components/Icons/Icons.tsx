...
import TabTools from './Sources/TabTools';
...
import { ToolEllipse } from './Sources/ToolEllipse';
import { ToolRect } from './Sources/ToolRect';
import { ToolScrollStack as ToolScrollStackCustom } from './Sources/ToolScrollStack';
import { PanelMeasurements } from './Sources/PanelMeasurements';
import { PanelSegments } from './Sources/PanelSegments';
import { ToolWindowLevel as ToolWindowLevelCustom } from './Sources/ToolWindowLevel';
import { ToolZoom as ToolZoomCustom } from './Sources/ToolZoom';
import { ToolPan } from './Sources/ToolPan';
import { ToolLength as ToolLengthCustom } from './Sources/ToolLength';
import { ToolAngle as ToolAngleCustom } from './Sources/ToolAngle';
//
//
...
export const Icons = {
  ...
  Trash,
  ViewportViews,
  // New custom Phase-3 icons
  ToolEllipse,
  ToolRect,
  ToolScrollStackCustom,
  PanelMeasurements,
  PanelSegments,
  ToolWindowLevelCustom,
  ToolZoomCustom,
  ToolPan,
  ToolLengthCustom,
  ToolAngleCustom,
  ...
  'tab-tools': (props: IconProps) => TabTools(props),
