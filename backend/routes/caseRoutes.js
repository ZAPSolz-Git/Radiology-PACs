...
import { uploadCase, getCases, assignCase, getCaseById, getCaseMetadata, deleteCase, submitCase, updateCase, resolveRejection, addAttachment, exportCaseZip, getDeleteImpact } from "../controllers/caseController.js";
...
router.route("/upload")
    .post(
        ...
        upload.fields([{ name: 'files' }, { name: 'attachments' }]),
        uploadCase
    );
