 ...
 * Handles modality normalization and fuzzy study type matching.
 */
export const findMatchingTariff = (allTariffs, modality, studyType, hospitalId, radiologistId) => {
    ...
    // Helper for common matching logic
    ...
    const isStudyMatch = (t) => {
        ...
        return tStudy === normalizedStudyType ||
            normalizedStudyType?.includes(tStudy) ||
            tStudy.includes(normalizedStudyType);
    };
